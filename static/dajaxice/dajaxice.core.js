...
var Dajaxice = {
    ...
    say_hello: function(callback_function, argv, custom_settings){
        Dajaxice.call('noise_app.say_hello', 'POST', callback_function, argv, custom_settings);
    }
...
,
    ...
    call: function(dajaxice_function, method, dajaxice_callback, argv, custom_settings)
    {
        ...
        var send_data = 'argv='+encodeURIComponent(JSON.stringify(argv)),
            ...
            endpoint = '/noise_app/dajaxice/'+dajaxice_function+'/';
